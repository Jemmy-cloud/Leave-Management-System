...
<script runat="server">
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        conn.ConnectionString  ="Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=|DataDirectory|Database1.mdf;Integrated Security=True";
         string strInsert = String.Format("INSERT INTO Employee VALUES('{0}', '{1}', '{2}', '{3}', '{4}', '{5}', '{6}', '{7}')", txtFname.Text, txtLname.Text, rblSex.SelectedValue, txtEmail.Text, txtPhone.Text, ddlCountry.SelectedValue, txtUsername.Text, txtPassword.Text);
...
<body>
    <form id="form1" runat="server">
        <div>
            <asp:Label ID="Label1" runat="server" Font-Names="Microsoft YaHei" Font-Size="XX-Large" ForeColor="#003300" Text="To Sign Up, Fill In All the Following Fields, Then Click Submit"></asp:Label>
        </div>
        <p>
        ...
        <table class="auto-style1">
            ...
            <tr>
                ...
                <td class="auto-style9">
                    <asp:TextBox ID="txtLname" runat="server" Font-Names="Arial" Font-Size="Medium" ForeColor="#000066" Width="212px"></asp:TextBox><br />
                     <font face="aria"l color="#000022" size="-1">Example: Ahmed or Abdel Rahman</font>
                </td>
                <td>
